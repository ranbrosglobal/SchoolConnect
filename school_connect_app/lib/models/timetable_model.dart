...
class ScheduleRow {
  ...
  factory ScheduleRow.fromJson(Map<String, dynamic> json) {
    return ScheduleRow(
      ...
      courseName: json['course_name'] as String? ?? json['subject'] as String? ?? json['course'] as String? ?? 'Class',
      room: json['room'] as String?,
      instructorName: json['instructor_name'] as String? ?? json['instructor'] as String? ?? json['teacher_name'] as String? ?? json['teacher_id'] as String?,
      studentGroupName: json['student_group_name'] as String?,
      classId: json['class_id'] as String? ?? json['class'] as String?,
