...
class _SignupScreenState extends ConsumerState<SignupScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          _socialBtn(const Icon(Icons.g_mobiledata, color: Color(0xFFEA4335), size: 30)),
                          const SizedBox(width: 16),
                          _socialBtn(const Icon(Icons.window, color: Color(0xFF00A4EF), size: 26)),
                          const SizedBox(width: 16),
                          _socialBtn(const Icon(Icons.apple, color: Colors.black, size: 26)),
                        ],
                      ),
  ...
  Widget _socialBtn(Widget child) {
    return Container(
      width: 62,
      height: 46,
      decoration: BoxDecoration(
