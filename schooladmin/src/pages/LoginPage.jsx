...
const QUICK_LOGINS = [
  { label: 'School Admin · Springfield', email: 'priya@springfield.edu', pwd: 'admin123' },
  { label: 'School Admin · Riverside', email: 'ravi@riverside.edu', pwd: 'admin123' },
  { label: 'School Admin · Sunrise', email: 'aman@sunrise.edu', pwd: 'admin123' },
]
    ...
    <div className="grid min-h-screen lg:grid-cols-[1.05fr_1fr]">
      ...
      <div className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-[#1e2d8a] to-primary p-10 text-white lg:flex">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/70">School Admin Console</p>
          </div>
        </div>

        <div className="relative max-w-md">
          <h1 className="text-4xl font-extrabold leading-tight tracking-tight">
            Your school. Every class. One console.
          </h1>
          <p className="mt-4 text-white/80">
            Teachers, classes, students and the weekly timetable — managed from a single console.
          </p>

        </div>

        <p className="relative text-xs text-white/60">
          © {new Date().getFullYear()} School Connect · School Admin Console
        </p>
      </div>
      ...
      <div className="flex items-center justify-center bg-background px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="mt-1 text-sm text-ink-soft">Sign in to your admin account to continue.</p>
